...
### 🌍 FreakyTravellers
**Live**: [freaky-travellers.vercel.app](https://freaky-travellers.vercel.app)  
**Tech Stack**: Next.js 14 • Tailwind CSS • Framer Motion • Zustand • Node.js • Express.js • MongoDB • JWT • Razorpay  
An AI-powered budget travel optimization web app that finds the cheapest transport, best hotels within your budget, and recommends restaurants. Features smart budget allocation, secure JWT authentication with email OTP, and Razorpay payment integration.

---

### 📚 Edvora (StudyNotion)
**Live**: [edvora-beryl.vercel.app](https://edvora-beryl.vercel.app/)  
**Tech Stack**: React • Node.js • Express.js • MongoDB  
A comprehensive EdTech platform for creating, consuming, and rating educational content with an AI-powered virtual teacher. Fast, responsive learning experience with seamless content management.

---

### 💼 SmartFolio
**Live**: [smartfolio-nine.vercel.app](https://smartfolio-nine.vercel.app/)  
**Description**: An investment portfolio dashboard that brings your stocks, funds, and cash into one clean interface. Always know where you stand and what to do next.
